...
const [name,setname] = useState("")
  ...
  const handleSubmit = async(e :    any)=>{
    ...
    try{
const response = await axios.post("/user/signup/api", userData)
...
setname ("");
  ...
  return (
    ...
    <div style={{marginTop: 100}}>
      ...
      <h1 style={{textAlign:"center", fontSize:30, fontWeight:"bold", marginBottom:40}}>SignUp Form</h1>
       
<form className="max-w-sm mx-auto" onSubmit={handleSubmit}>
<div className="mb-5">
    <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Your name</label>
    <input type="text" value={name} id="name" onChange={(e)=>setname(e.target.value)}className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="enter your name" required />
  </div>
  <div className="mb-5">
  ...
  <button type="submit" style={{marginLeft:180}} onClick={handleClick} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login Form</button>
